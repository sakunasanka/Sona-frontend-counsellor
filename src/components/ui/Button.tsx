...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    primary: 'bg-primary text-black hover:bg-primary-hover focus:ring-2 focus:ring-primary-ring rounded-xl cursor-pointer',
    ...
    border: 'text-primary bg-bg hover:bg-primary hover:text-bg focus:ring-2 focus:ring-primary-ring rounded-xl cursor-pointer',
    ...
    special: 'bg-[#1f2937] text-white px-2 py-2 rounded-full text-sm hover:bg-white hover:text-[#1f2937] cursor-pointer', 
  };
