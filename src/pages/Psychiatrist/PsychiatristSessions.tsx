            ...
            <div className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-secondaryDusk font-medium">@{session.username}</p>
                    </div>
                ...
                <div className="flex flex-wrap items-center gap-4 mb-4">
                    ...
                    {session.mood && (
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                            <div className={`w-3 h-3 rounded-full ${session.mood === 'positive' ? 'bg-green-400' :
                ...
                <div className="pt-2 border-t border-gray-100">
                    <button
                        ...
                        className="w-full lg:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-secondaryDarker text-white rounded-xl hover:bg-secondaryDusk hover:bg-opacity-90 transition-all duration-200 font-medium text-sm"
                    >
                                ...
                                <div className="flex-1">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-500 bg-gray-50 focus:bg-white focus:border-secondaryDarker focus:border-opacity-10 focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-10 transition-all duration-200 outline-none shadow-sm"
                                        />
                                        {searchTerm && (
                                            <button
                                ...
                                <div className="flex gap-3 lg:gap-4 w-full lg:w-auto">
                                    <div className="relative flex-1 lg:flex-initial lg:min-w-[140px]">
                                        <select
                                            ...
                                            className="appearance-none w-full pl-4 pr-10 py-3.5 border border-gray-200 rounded-xl text-sm text-gray-900 bg-gray-50 hover:bg-white focus:bg-white focus:border-secondaryDarker focus:border-opacity-50 focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-20 transition-all duration-200 outline-none cursor-pointer shadow-sm font-medium"
                                        >
                                    ...
                                    <div className="relative flex-1 lg:flex-initial lg:min-w-[130px]">
                                        <select
                                            ...
                                            className="appearance-none w-full pl-4 pr-10 py-3.5 border border-gray-200 rounded-xl text-sm text-gray-900 bg-gray-50 hover:bg-white focus:bg-white focus:border-secondaryDarker focus:border-opacity-20 focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-20 transition-all duration-200 outline-none cursor-pointer shadow-sm font-medium"
                                        >
