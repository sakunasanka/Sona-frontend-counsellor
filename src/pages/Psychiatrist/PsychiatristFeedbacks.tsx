...
const PsychiatristFeedbacks: React.FC = () => {
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-4 overflow-hidden">
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="flex items-center gap-4 py-2 border-b border-gray-100">
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md ${
                feedback.isLiked ? 'bg-red-50 text-red-600 border border-red-200' : 'bg-gray-50 text-gray-600 border border-gray-200 hover:bg-gray-100'
              }`}
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium bg-gray-50 text-gray-600 border border-gray-200 hover:bg-gray-100 transition-all duration-200 shadow-sm hover:shadow-md"
            >
        ...
        {feedback.reply && (
          <div className="px-4 md:px-6 pb-4">
            <div className="bg-secondaryDarker/60 rounded-xl p-4 border-l-4 border-secondaryDusk">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="bg-secondaryDarker text-white px-2 py-0.5 rounded-full text-xs font-medium">
                      Counsellor
                    </span>
                  </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-secondaryDarker-200 focus:border-secondaryDusk-300 transition-colors"
                    rows={3}
                    autoFocus
                  />
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-4 py-2 text-sm text-gray-600 hover:text-gray-800 bg-gray-100 hover:bg-gray-200 rounded-xl transition-all duration-200 font-medium"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="flex items-center gap-2 bg-secondaryDarker hover:bg-secondaryDusk text-white px-6 py-2 rounded-xl text-sm font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
                      >
            ...
            <div className="flex-1 overflow-auto p-4 lg:p-6">
                ...
                {filteredFeedbacks.length > 0 && (
                    <div className="text-center mt-8">
                        <button className="bg-secondaryDarker hover:bg-secondaryDusk text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 shadow-sm hover:shadow-md">
                            Load More Feedbacks
                        </button>
                    </div>
                )}
...
export default PsychiatristFeedbacks