                ...
                <div className="flex p-4 flex-1">
                    ...
                    <div className="ml-4 flex-1 min-w-0">
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-medium h-fit ${client.status === 'active' ? 'bg-[rgb(174,175,247)] bg-opacity-25 text-indigo-800' :
                ...
                <div className="border-t md:border-t-0 md:border-l border-gray-100 bg-gray-50 md:w-64 lg:w-72 flex-shrink-0">
                    <div className="p-4">
                        ...
                        <div className="mt-4 flex flex-col space-y-2">
                            <button
                                className="w-full py-1.5 px-3 bg-secondaryDarker hover:bg-secondaryDusk text-white text-sm font-medium rounded-md transition-colors flex items-center justify-center gap-1 focus:outline-none focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-50"
                                onClick={() => window.location.href = `/psychiatrist-chats?clientId=${client.id}`}
                            >
                                <MessageCircle className="w-4 h-4" />
                                Message
                            </button>
                            <button
                                className="w-full py-1.5 px-3 bg-secondaryDarker hover:bg-secondaryDusk text-white text-sm font-medium rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-50"
...
const PsychiatristPatients: React.FC = () => {
    ...
    const handleViewClientDetails = (clientId: number) => {
        navigate(`/psychiatrist-patients/${clientId}`);
    };
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-1 overflow-auto p-4 lg:p-6">
                    ...
                    <div className="mb-6 lg:mb-8">
                        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">My Patients</h1>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
                        <div className="p-4">
                            <div className="relative w-full">
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-50 focus:border-secondaryDarker focus:border-opacity-50 transition-all"
                                    value={searchQuery}
                        ...
                        <div className="border-t border-gray-100 px-4 py-2 flex flex-wrap gap-2 items-center">
                            <div className="flex items-center flex-wrap gap-2">
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${activeFilter === 'all' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${activeFilter === 'active' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${activeFilter === 'new' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${activeFilter === 'inactive' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                            ...
                            <div className="flex items-center flex-wrap gap-2">
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${anonymousFilter === 'all' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${anonymousFilter === 'anonymous' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${anonymousFilter === 'identified' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                            ...
                            <div className="flex items-center flex-wrap gap-2">
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${studentFilter === 'all' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${studentFilter === 'student' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                                ...
                                <button
                                    className={`px-3 py-1 text-xs font-medium rounded-full transition-colors ${studentFilter === 'non-student' ? 'bg-secondaryDarker text-white' : 'bg-gray-100 text-gray-700 hover:bg-secondaryDusk hover:text-white'
                                        }`}
                        ...
                        {filterOpen && (
                            <div className="border-t border-gray-100 p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center">
                                            <input
                                                ...
                                                className="h-4 w-4 text-secondaryDusk border-gray-300 focus:ring-secondaryDusk focus:ring-opacity-50"
                                                style={{ accentColor: 'rgb(126, 86, 144)' }}
                                ...
                                <div>
                                    ...
                                    <select className="w-full px-3 py-1.5 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-50 focus:border-secondaryDarker focus:border-opacity-50">
                    ...
                    <div className="flex flex-wrap items-center justify-between mb-6 gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select className="text-sm border border-gray-200 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-50 focus:border-secondaryDarker focus:border-opacity-50">
                    ...
                    {filteredClients.length > 0 ? (
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
                            ...
                            {searchQuery && (
                                <button
                                    className="text-secondaryDarker hover:text-secondaryDusk font-medium focus:outline-none focus:ring-2 focus:ring-secondaryDarker focus:ring-opacity-50 rounded px-2 py-1"
                                    onClick={() => setSearchQuery('')}
                                >
                                    Clear search
                                </button>
