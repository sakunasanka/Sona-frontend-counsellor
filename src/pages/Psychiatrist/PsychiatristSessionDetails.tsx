...
const PsychiatristSessionDetails: React.FC = () => {
    ...
    const sessionData: SessionDetails = {
        ...
        profileImage: "/assets/images/patient-photo.jpg",
                            ...
                            <div className="p-4 sm:p-6 border-b border-gray-100">
                                <div className="flex items-start gap-4 sm:gap-6">
                                    <div className="relative">
                                        <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full overflow-hidden border-4 border-white shadow-lg flex-shrink-0 bg-white">
                                            <img
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-secondaryDusk text-sm sm:text-base font-medium mb-3">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-1">Total Sessions</p>
                                            <p className="text-sm sm:text-base font-semibold text-gray-900">{sessionData.previousSessions}</p>
                                        </div>
                                    </div>
                                    ...
                                    {sessionData.rating && (
                                        <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-1">Average Rating</p>
                                                <p className="text-sm sm:text-base font-semibold text-gray-900">{sessionData.rating}/5</p>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-2">Main Concerns</p>
                                            <div className="flex flex-wrap gap-2">
                                                {sessionData.concerns.map((concern, index) => (
                                                    <span
                                                        key={index}
                                                        className="px-3 py-1.5 bg-white text-gray-700 text-xs font-medium rounded-full border border-gray-200"
                                                    >
                                                        {concern}
                                                    </span>
                                                ))}
...
export default PsychiatristSessionDetails;
