...
const PatientDetails: React.FC = () => {
    const { clientId } = useParams<keyof PatientDetailsParams>() as PatientDetailsParams;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
                    <div className="flex justify-between items-start">
                        ...
                        <div className={`p-2 rounded-lg ${currentClient.status === 'active' ? 'bg-[rgb(174,175,247)] bg-opacity-25' :
                                currentClient.status === 'new' ? 'bg-blue-50' :
                                    'bg-orange-50'
                            }`}>
                            <span className={`w-6 h-6 ${currentClient.status === 'active' ? 'text-indigo-500' :
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <button
                        ...
                        onClick={() => window.location.href = `/psychiatrist-chats?clientId=${clientId}`}
                    >
            ...
            <div ref={recentNotesRef} className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div className="mt-4">
                    <textarea
                        ...
                        className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondaryDarker text-sm"
                        rows={2}
                        value={newNote}
                    ...
                    <div className="flex justify-between mt-2">
                        <div className="flex items-center">
                            <input
                                type="checkbox"
                                id="privateQuickNote"
                                className="h-4 w-4 text-primary border-gray-300 rounded focus:ring-secondaryDarker"
                        ...
                        <button
                            className={`px-4 py-2 ${!newNote.trim() ? 'bg-gray-300 cursor-not-allowed opacity-50' : 'bg-secondaryDarker hover:bg-secondaryDusk'} text-white rounded-md text-sm font-medium flex items-center transition-all`}
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <div className="mb-6">
                <textarea
                    ...
                    className="w-full p-4 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondaryDarker text-sm"
                    rows={4}
                    value={newNote}
                    onChange={(e) => setNewNote(e.target.value)}
                ></textarea>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${currentClient.status === 'active' ? 'bg-secondaryDarker text-white' :
                                                currentClient.status === 'new' ? 'bg-secondaryDarker text-white' :
                                                    'bg-secondaryDarker text-white'
                                            }`}>
                                    ...
                                    <div className="mt-1 flex items-center gap-2 flex-wrap">
                                        ...
                                        {currentClient.student && (
                                            <div className="flex items-center gap-1">
                                                <span className="inline-flex items-center px-2 py-0.5 bg-secondaryDarker text-white text-xs rounded-full">
                        ...
                        <div className="mt-6 border-b border-gray-200">
                            <nav className="flex space-x-6 overflow-x-auto pb-2">
                                <button
                                    className={`pb-2 text-sm font-medium -mb-px ${activeTab === 'overview' ? 'border-b-2 border-secondaryDarker text-secondaryDusk' : 'text-gray-500 hover:text-gray-700'}`}
                                    onClick={() => setActiveTab('overview')}
                                >
                                    Overview
                                </button>
                                <button
                                    className={`pb-2 text-sm font-medium -mb-px ${activeTab === 'notes' ? 'border-b-2 border-secondaryDarker text-secondaryDusk' : 'text-gray-500 hover:text-gray-700'}`}
                                    onClick={() => setActiveTab('notes')}
                                >
                                    Notes
                                </button>
                                <button
                                    className={`pb-2 text-sm font-medium -mb-px ${activeTab === 'sessions' ? 'border-b-2 border-secondaryDarker text-secondaryDusk' : 'text-gray-500 hover:text-gray-700'}`}
                                    onClick={() => setActiveTab('sessions')}
                                >
                                    Sessions
                                </button>
                                <button
                                    className={`pb-2 text-sm font-medium -mb-px ${activeTab === 'details' ? 'border-b-2 border-secondaryDarker text-secondaryDusk' : 'text-gray-500 hover:text-gray-700'}`}
                                    onClick={() => setActiveTab('details')}
                                >
                                    Client Details
                                </button>
